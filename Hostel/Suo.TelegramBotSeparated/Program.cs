...
builder.Services.AddDbContext<HostelDbContext>(options => options.UseMySql(builder.Configuration.GetConnectionString("HostelContext"), ServerVersion.AutoDetect(builder.Configuration.GetConnectionString("HostelContext"))));
